package com.sebade.roomrepoinjection.data

import android.util.Log
import androidx.lifecycle.LiveData
import androidx.lifecycle.MediatorLiveData
import com.sebade.roomrepoinjection.BuildConfig
import com.sebade.roomrepoinjection.data.local.entity.NewsEntity
import com.sebade.roomrepoinjection.data.local.room.NewsDao
import com.sebade.roomrepoinjection.data.remote.response.NewsResponse
import com.sebade.roomrepoinjection.data.remote.retrofit.ApiService
...
class NewsRepository private constructor(
    ...
    fun getHeadlineNews(): LiveData<Result<List<NewsEntity>>> {
        Log.d(TAG, "getHeadLinesNews: before ${result.value}")
        result.value = Result.Loading
        Log.d(TAG, "getHeadLinesNews: before ${result.value} || $result.value")
